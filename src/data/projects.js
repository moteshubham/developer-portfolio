export const projects = [ 
  ...
  {
    title: 'Screener',
    description: 'Candidate screening platform integrating Azure APIs with Python Flask backend. Automated interview scheduling and data collection, reducing manual coordination for large-scale hiring processes. Developed a responsive React frontend for seamless user experience.',
    tech: ['React', 'Python Flask', 'Azure APIs'],
    github: '#',
  },
  {
